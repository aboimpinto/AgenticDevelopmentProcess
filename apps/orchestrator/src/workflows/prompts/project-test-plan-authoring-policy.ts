/** Project-owned command authoring; does not change runtime snapshot policy. */
export const PROJECT_TEST_PLAN_AUTHORING_POLICY = `## Project-owned verification commands
